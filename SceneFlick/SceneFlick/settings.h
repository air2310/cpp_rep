...
public:
	...
	struct general {
		...
		sf::Vector2f numSquares = sf::Vector2f(10, 10);
		float numBlocks = 8;
		...
		std::vector<float> makePhase(int nFreqs) {
			...
			,0.00f, 0.35f, 0.70f,1.05f,1.40f, 1.75f,0.10f,0.45f,0.80f,1.15f,1.50f,1.85f,0.20f,0.55f,0.90f,1.25f,1.60f,1.95f,0.30f,0.65f
				,1.00f,1.35f,1.70f,0.05f,0.40f,0.75f,1.10f,1.45f,1.80f,0.15f,0.50f,0.85f,1.20f,1.55f,1.90f,0.25f,0.60f,0.95f,1.30f,1.65f
			,0.00f, 0.35f, 0.70f,1.05f,1.40f, 1.75f,0.10f,0.45f,0.80f,1.15f,1.50f,1.85f,0.20f,0.55f,0.90f,1.25f,1.60f,1.95f,0.30f,0.65f	 };
