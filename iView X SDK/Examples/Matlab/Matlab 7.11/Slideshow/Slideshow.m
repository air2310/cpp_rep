...
if connected 
	...
	try 
		...
		% show first image 
		calllib('iViewXAPI', 'iV_SendImageMessage', 'image01.jpg');
		...
		% show second image 
		calllib('iViewXAPI', 'iV_SendImageMessage', 'image02.jpg');
		...
		% show third image 
		calllib('iViewXAPI', 'iV_SendImageMessage', 'image03.jpg');
		...
		ovr = int32(1);
		filename = ['D:\iViewXSDK_Matlab_Slideshow_Data_' user '.idf'];
