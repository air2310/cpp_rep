    ...
    try 
        ...
        for i = 1:1000
            ...
            if (ret == 1)
                ...
                [int2str(Smp.timestamp) ' - GazeX: ' int2str(Smp.leftEye.gazeX) ' - GazeY: ' int2str(Smp.leftEye.gazeY) ' - DiameterL: ' int2str(Smp.leftEye.diam) ' - DiameterR: ' int2str(Smp.rightEye.diam)]
                pause(0.01);
